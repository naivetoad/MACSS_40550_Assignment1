...
model_params = {
    ...
    "city_distance": mesa.visualization.Slider(
        name="City Distance", 
        value=0, min_value=0, max_value=int(math.sqrt(20**2 + 20**2) / 2), step=1) #Hard coded at this point because we hardcode height and width. to be edited if this changes.
}
