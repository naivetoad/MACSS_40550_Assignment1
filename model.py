...
class SchellingAgent(mesa.Agent):
    ...
    def step(self):
        # Two city centers are located at the bottom-left corner and the top-right corner
        # Find the manhattan distance to the nearest city center 
        distance_to_center = min(abs(self.pos[0] - 0) + abs(self.pos[1] - 0), 
                                 abs(self.pos[0] - (self.model.width - 1)) + 
                                 abs(self.pos[1] - (self.model.height - 1)))
